...
def run(argv):
    file_name = "Fm3m.csv"
    tv = "Formation_energy"
    rm_cols= ["A_Z","B_Z","A_type","B_type","A_element","B_element","A_row","A_group","A_block","B_row","B_group","B_block"]
    num_clusters = 3
    init='random'
    n_init = 50
    input_dir = "input"
    ...
    pv.remove(tv)
    # pv = ["volumne", "A_e_negativity", "A_first_ionization", "A_boiling_point", "A_melting_point", "B_atomic_radius",
    # "A_valence_e", "B_valence_e", "B_e_negativity","B_first_ionization", "B_melting_point","A_atomic_radius","B_boiling_point"] #4
